...
{
    public class SingleTenderModel
    {
        ...
        public string Submission_EndTime { get; set; }
        ...
        public string Mandatory_Special_Group_Reserv { get; set; }
        public string Enforce_Mandatory_Pre_bid_Visi { get; set; }
        ...
        public decimal? Bid_Charge_LCY { get; set; }
        public string Bid_Charge_Bank_Code { get; set; }
        public string Bank_Name { get; set; }
        public string Bank_Account_Name { get; set; }
        public string Bid_Charge_Bank_Branch { get; set; }
        public string Bid_Charge_Bank_A_C_No { get; set; }
        public string Sealed_Bids { get; set; }
        ...
        public DateTime Mandatory_Pre_bid_Visit_Date { get; set; }
        ...
        public string Performance_Security_Required { get; set; }
        public string Bid_Tender_Security_Required { get; set; }
        ...
        public string Advance_Payment_Security_Req { get; set; }
        public decimal Advance_Payment_Security { get; set; }
        public string Bid_Security_Validity_Duration { get; set; }
        public DateTime? Bid_Security_Expiry_Date { get; set; }
        public decimal Advance_Amount_Limit { get; set; }
        public string Insurance_Cover_Required { get; set; }
